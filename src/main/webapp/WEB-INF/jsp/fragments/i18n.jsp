...
<script type="text/javascript">
    ...
    <c:forEach var='key' items='<%=new String[]{"common.deleted", "common.saved", "common.enabled", "common.disabled", "common.errorStatus", "common.confirm", "error.user.email.duplicate"}%>'>
