            ...
            <div class="container">
                ...
                <form id="filterForm">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="date" name="startDate" class="" id="startDate" value="${param.startDate}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="date" name="endDate" class="" id="endDate" value="${param.endDate}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="time" name="startTime" class="" id="startTime" value="${param.startTime}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="time" name="endTime" class="" id="endTime" value="${param.endTime}">
                        </div>
                    </div>
